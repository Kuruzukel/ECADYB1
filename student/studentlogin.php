...
.title {
    ...
    margin-top: 20px; /* Added or increased */
    margin-bottom: 10px;
}
...
.subtitle {
    ...
    input {
    background-color:rgb(255, 255, 255); /* Keep background color */
...
input::placeholder {
    color: rgb(0, 0, 0); /* Light white for readability */
}
...
button[type='submit'] {
    ...
    outline: none;
    border: none;
    margin-top: 1rem; /* reduce this to move it closer to the top */
...
button[type='submit']:hover {
    ...
    max-width: 55%;
    max-height: 55%;
    margin-bottom: 0rem; /* Move it closer to the top */
