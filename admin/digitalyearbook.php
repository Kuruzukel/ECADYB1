...
<head>
    ...
    <style>
        ...
        * {
        ...
        opacity: 0;
            ...
            .menu-items {
            margin-top: 1rem; /* You can adjust to 3rem, 4rem etc to move lower */
    ...
    height: 200px;
    display: block;
    margin: 5 auto; /* Centers the logo */
    padding: 3px 3px; /* Adds spacing above and below */
}
...
.search-container {
        ...
        /* Optional: Animation when focused */
        @keyframes pulse {
            0% { box-shadow: 0 0 0 0 rgba(0, 30, 1, 0.4); }
...
<body>
    ...
    <main>
        <div class="sidebar closed">
            ...
            <!-- ✅ Wrapped links in a new container -->
  ...
  <div class="search-container">
    ...
    function toggleSubmenu(id) {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            // Get current page URL or query parameter
            ...
            // Check if we need to expand any submenus
        ...
        function setActiveTab(currentPage) {
            document.querySelectorAll('.tab, .sub-tab').forEach(tab => {
                ...
                // Check sub-tabs with query params
        ...
        // Automatically expand parent menu if a sub-tab is active
        ...
        // Handle tab clicks (for non-link tabs)
        ...
        document.querySelectorAll('.sub-tab').forEach(tab => {
            tab.addEventListener('click', function() {
                ...
                this.classList.add('active');
                // You might want to add AJAX content loading here
            });
        });
